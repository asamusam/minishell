...
CFILES := src/main.c src/utils.c src/signals.c src/envp.c src/envp_utils.c \
          src/lexer.c src/lexer_token_func_spec.c src/lexer_token_func_word.c src/lexer_utils.c \
		  src/parser.c src/parser_utils.c src/parser_expand.c src/parser_expand_utils.c src/parser_cmd.c src/parser_free.c
OFILES := $(CFILES:.c=.o)
INCLUDE := include
LIBFT_PATH := libft/
LIBFT := libft.a
